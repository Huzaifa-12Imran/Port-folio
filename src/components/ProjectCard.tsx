            ...
            >
              ...
              <div className={styles.techChips}>
                {project.tech.slice(0, 5).map((t) => (
                  <div key={t} className={styles.techChipCompact}>
                    {t}
                  </div>
                ))}
              </div>
              ...
              <div className={styles.modalRoot}>
                ...
                >
                  ...
                  <div className={styles.modalHero}>
                    {project.liveUrl ? (
                      <img 
                        src={`https://s.wordpress.com/mshots/v1/${encodeURIComponent(project.liveUrl)}?w=800`} 
                        alt={project.title} 
                      ...
                      <div 
                        ...
                        style={{ background: project.placeholderColor || 'var(--color-bg)' }}
                      >
                  ...
                  <div className={styles.modalTechChips}>
                    {project.tech.map((t) => (
                      <div key={t} className={styles.modalTechChip}>
                        {t}
                      </div>
                    ))}
                  </div>
