...
import { FaGithub, FaLinkedinIn, FaInstagram, FaFacebook, FaWhatsapp } from "react-icons/fa";
import { SiGmail } from "react-icons/si";
import { GiLaurelCrown } from "react-icons/gi";

const RESUME_DRIVE_VIEW_URL =
  "https://drive.google.com/file/d/1ZWoVI8tUdCtkzV6CLD18SpiKuLJ0U5zd/view?usp=sharing";
const RESUME_DRIVE_DOWNLOAD_URL =
  "https://drive.google.com/uc?export=download&id=1ZWoVI8tUdCtkzV6CLD18SpiKuLJ0U5zd";
...
const socialProfiles = [
  {
    id: "github",
    label: "GitHub",
    username: "@Huzaifa-12Imran",
    url: "https://github.com/Huzaifa-12Imran",
    Icon: FaGithub,
    previewSrc: buildPreviewShot("https://github.com/Huzaifa-12Imran"),
  },
  {
    id: "linkedin",
    label: "LinkedIn",
    username: "Huzaifa Imran",
    url: "https://www.linkedin.com/in/huzaifa-imran-12b10b3b3/",
    Icon: FaLinkedinIn,
    previewSrc: buildPreviewShot("https://www.linkedin.com/in/huzaifa-imran-12b10b3b3/"),
  },
  {
    id: "instagram",
    label: "Instagram",
    ...
    Icon: FaInstagram,
    previewSrc: buildPreviewShot("https://www.instagram.com"),
  },
  {
    id: "facebook",
    label: "Facebook",
    ...
    Icon: FaFacebook,
    previewSrc: buildPreviewShot("https://www.facebook.com/huzaifa.imran.75098364"),
  },
  {
    id: "whatsapp",
    label: "WhatsApp",
    ...
    Icon: FaWhatsapp,
    previewSrc: buildPreviewShot("https://wa.me/923096123772"),
  },
  {
    id: "gmail",
    label: "Gmail",
    username: "sungpg89@gmail.com",
    url: "mailto:sungpg89@gmail.com",
    Icon: SiGmail,
    previewSrc: "", // No preview for email
  },
] as const;
  ...
  return (
    <>
      ...
      >
        ...
        >
          <span className="brand-first">Huzaifa</span>
        </motion.div>
